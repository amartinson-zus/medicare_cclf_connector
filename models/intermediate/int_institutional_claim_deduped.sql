...
, add_claim_line_details as (
    ...
    from filter_claims
        ...
        left join diagnosis_pivot
            ...
            and filter_claims.current_bene_mbi_id = diagnosis_pivot.current_bene_mbi_id
        left join procedure_pivot
            on filter_claims.cur_clm_uniq_id = procedure_pivot.cur_clm_uniq_id
            and filter_claims.current_bene_mbi_id = procedure_pivot.current_bene_mbi_id
...
, remove_dupes as (
    ...
    from (
        select
              add_claim_line_details.*
            , row_number() over (
                partition by
                      cur_clm_uniq_id
                    , coalesce(clm_line_num, '1')
                    , current_bene_mbi_id
                order by
                      file_date desc
                    , clm_efctv_dt desc
...
, mapping as (
    ...
    select
        ...
        , remove_dupes.bene_mbi_id as bene_mbi_id
